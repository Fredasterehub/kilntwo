I could not create files in this session due a sandbox `LandlockRestrict` failure on all write attempts.  
Here is the exact content for `assets/commands/kw/resume.md`:
