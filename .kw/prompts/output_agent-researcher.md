I couldn’t write the file because the environment is currently blocking file operations with:

`error applying legacy Linux sandbox restrictions: Sandbox(LandlockRestrict)`

No files were modified.

Here is the exact content for `assets/agents/kw-researcher.md`:
...
If you fix the sandbox restriction, I can create it directly in `/DEV/kilntwo/assets/agents/kw-researcher.md` immediately.