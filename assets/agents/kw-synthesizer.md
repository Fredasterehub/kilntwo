...
- Read `.kw/plans/claude_plan.md` and `.kw/plans/codex_plan.md` in parallel before producing any output, and read `.kw/plans/debate_resolution.md` only if a debate resolution path was provided; skip it if absent.
